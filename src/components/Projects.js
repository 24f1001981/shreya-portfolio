...
const projects = [
  {
    title: 'Soil Doctor',
    subtitle: 'Smart Portable Soil Health Analyzer',
    meta: '[Model: SDX-01]',
    ...
    links: {
      // FIX: removed duplicate top-level github key; kept only inside links
      demo: '', // FIX: was '#', hiding the button anyway — set real URL or leave empty
      linkedin: 'https://www.linkedin.com/posts/shreya-s-n-geck_embeddedai-esp32-ai-ugcPost-7465386911264583681-ai9P/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADMPzHEBleB7JPtfyZbwAwnXWrhhZMnKu2I',
      github: 'https://github.com/24f1001981/Soil-Doctor-KTU-Miniproject-',
      sparkwhiz: 'https://sites.google.com/view/sparkwhiz/electrosphere/realwire/soil-doctor?authuser=0',
    },
  },
  {
    title: 'RecruitEase',
    subtitle: 'Placement Portal Application',
    ...
    links: {
      demo: 'https://drive.google.com/file/d/1FzIQ6Jdh5mqZCQnzj7Ge5lkJPONDRvBE/view?usp=sharing',
      linkedin: 'https://www.linkedin.com/posts/shreya-s-n-geck_iitmadras-bsdatascience-flask-activity-7460733168028000257-Ylqm?utm_source=share&utm_medium=member_desktop&rcm=ACoAADMPzHEBleB7JPtfyZbwAwnXWrhhZMnKu2I',
      github: 'https://github.com/24f1001981/placement-portal-app',
      sparkwhiz: 'https://sites.google.com/view/sparkwhiz/codecanvas/appstudio/placement-portal-system?authuser=0',
    },
  },
  {
    title: 'CircuitGuard',
    ...
    screenshots: [
      ...
      '/images/circuitguard/circuitguard.png', // FIX: removed double comma
    ],
    links: {
      demo: 'https://drive.google.com/file/d/1rLBct0EhoUBXl7SiQaQ-xzD3Z8qEhbHd/view?usp=sharing',
      linkedin: 'https://www.linkedin.com/posts/shreya-s-n-geck_embeddedsystems-pic16f877a-engineeringstudent-activity-7341002822865297408-mTLa?utm_source=share&utm_medium=member_desktop&rcm=ACoAADMPzHEBleB7JPtfyZbwAwnXWrhhZMnKu2I',
      github: 'https://github.com/24f1001981/CircuitGuard',
      sparkwhiz: 'https://sites.google.com/view/sparkwhiz/electrosphere/simulab/circuitguard?authuser=0',
    },
  },
  {
    title: 'Adaptive Wireless Communication System',
    subtitle: 'Performance Analysis of Threshold-Based Modulation Switching over AWGN and Rayleigh Fading Channels',
  ...
  return (
    ...
    >
      ...
      <div className="project-links" onClick={e => e.stopPropagation()}>
        ...
        {/* FIX: also guard demo link properly — show only when non-empty */}
        {project.links.demo && (
